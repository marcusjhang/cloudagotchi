...
esp_err_t app_mqtt_start(app_mqtt_message_cb_t on_message)
{
    ...
    const esp_mqtt_client_config_t cfg = {
        ...
        .buffer = {
            // The briefing payload carries a presigned S3 URL (~1.4 KB).
            // The default 1024-byte RX buffer would split it across chunks
            // and the JSON would never parse — give it room to arrive whole.
            .size = 3072,
        },
    };
